-- Script de creación de bases de datos MySQL para el proyecto de microservicios del gimnasio
...
-- Usuario y permisos de ejemplo (ajustar credenciales según entorno)
